...
textSize(20);
fill(0, 102, 153);
text("p5.js is the most recent JavaScript implementation of the famous", 10, 60); 
 text( "desktop creative coding environment Processing. It takes much of the ", 10, 100); 
  text("power and ease of use of Processing and puts it into your browser.", 10, 140); 
